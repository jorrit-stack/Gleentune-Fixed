/*
  # Fix AM Frequency Display in stations_view

  1. Problem
    - Legacy radio_stations table stores:
      - FM frequencies in MHz (91.1, 98.3, 102.9)
      - AM frequencies in kHz (580, 730, 1030)
    - View was treating ALL frequencies as MHz and multiplying by 1000
    - Result: AM 580 kHz displayed as 580,000 kHz

  2. Solution
    - For FM: frequency is in MHz, multiply by 1000 for kHz
    - For AM: frequency is already in kHz, use as-is
    - Update both frequency_mhz and frequency_khz calculations

  3. Changes
    - Add CASE statement to handle band_type-specific conversion
*/
