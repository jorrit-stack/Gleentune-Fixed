/*
  # Fix Owner Field in stations_view
  
  1. Problem
    - The stations_view was setting owner to NULL for legacy radio_stations
    - Radio_stations table HAS owner data but view wasn't exposing it
  
  2. Solution
    - Change NULL::text AS owner to rs.owner in legacy section
    - This allows owner/network information to flow through to the UI
  
  3. Changes
    - Update stations_view to properly expose rs.owner field
*/
