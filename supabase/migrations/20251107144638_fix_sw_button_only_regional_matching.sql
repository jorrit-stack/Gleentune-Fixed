/*
  # Fix: Regional Matching ONLY for SW Button

  1. Problem
    - Applied regional matching to SW1, SW2, SW3 buttons (WRONG)
    - Should only apply to SW button (general shortwave)

  2. Correct Behavior
    - SW button: Regional matching (Asia, Global, etc.)
    - SW1/SW2/SW3 buttons: City-specific (like AM/FM)

  3. Changes
    - SW button: Use regional matching logic
    - SW1/SW2/SW3: Revert to city_id matching only
*/
