/*
  # Add source_url and license_tier to SW query results

  1. Changes
    - Drop existing function
    - Recreate with source_url and license_tier columns
    - Frontend can use source_url for "Visit Website" button
    - Frontend can use license_tier to block playback of restricted stations

  2. Purpose
    - Show SW stations but make restricted ones redirect to official websites
    - Match the behavior of FM restricted stations
*/
